...
<button id="HelpButton" data-dropdown-toggle="HelpOptions" type="button" class='rounded-l bg-indigo-600 hover:bg-indigo-700 text-white px-2 py-2 active:bg-indigo-800 text-sm border border-indigo-700' title="Insert command">
    <QuestionCircle/>
</button>

<div id="HelpOptions" class="z-10 hidden rounded shadow bg-slate-700 border border-slate-800 overflow-auto" style="height: 80vh;">
    ...
    <table class="table-auto my-2">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="https://raw.githubusercontent.com/pvme/rotation-builder/main/settings.json" class="text-blue-400 visited:text-purple-400">emojis.json</a></td>
          </tr>
          <tr>
